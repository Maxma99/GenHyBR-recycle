function [x, IterInfo] = IRwmrnsd(A, b, options, sigmaSq, beta)
%
%      [x, IterInfo] = IRwmrnsd(A, b, options, sigmaSq, beta);
%
%  Weighted Modified Residual Norm Steepest Descent
%  The WMRNSD algorithm can be interpreted as a preconditioned version of
%  MRNSD [2]
%
...
%
%  References:
%   [1]  J. M. Bardsley and J. G. Nagy.
%        "Covariance-preconditioned iterative methods for nonnegatively
%         constrained astronomical imaging",
%        SIAM J. Matrix Anal. Appl., 27:1184-1197,2006.   
%   [2]  J. G. Nagy and Z. Strakos.
%        "Enforcing nonnegativity in image reconstruction algorithms",
%         In et. al. D. C. Wilson, editor, Mathematical Modeling, 
%         Estimation, and Imaging, volume 3461, pages 182-190. SPIE, 2000.
...
if ~noIterBar
  h = waitbar(0, 'Beginning IRwmrnsd iterations: please wait ...');
end
