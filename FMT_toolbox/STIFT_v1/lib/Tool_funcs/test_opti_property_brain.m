...
% Wuwei Ren, 2017 Jul 5
% brain segmentation

close all;
clear all;
mouse_number=1;
level=0.05; % threshold for height map
...
for i =1:z_slice_n_update
    ...
    brain_BW = (filter_temp_img_uint>15)&(filter_temp_img_uint<40)&(tmp_img_seg>0);
    %tmp_img_seg(bone_BW) = 3;
    tmp_img_seg(brain_BW) = 4;
...
save([Folder_name '\brain_seg.mat'],'final_mri_256');
save([Folder_name '\brain_anatomy.mat'],'final_mri_anatomy');