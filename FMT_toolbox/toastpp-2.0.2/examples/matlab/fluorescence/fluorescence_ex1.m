...
figure;
subplot(2,1,1);imagesc(fltgt_g);colorbar;axis square;title('target fluoresence');
%subplot(2,2,2);imagesc(reshape(sim,grd));colormap(gray);colorbar;axis square;title('Image recscaling');
subplot(2,1,2);imagesc(reshape(xim,grd));colormap(gray);colorbar;axis square;title('reconstructed fluoresence');
